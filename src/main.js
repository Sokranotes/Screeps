...
/***/ (function(module, exports, __webpack_require__) {
	...
	function loop() {
	    Core.run();
	    //var drop_ro_e53s13 = Game.creeps['ExpansionWorker-T6-Uoq'].pos.find(FIND_DROPPED_RESOURCES);
	    //Game.creeps['ExpansionWorker-T6-Yid'].pickup(drop_ro_e53s13);
	    //console.log(drop_ro_e53s13);
	    //Game.creeps['OutpostDefender-T5-Qpf'].moveTo( new RoomPosition(48,29 , 'E53S13'));
	    //Game.creeps['OutpostDefender-T6-Hnd'].moveTo( new RoomPosition(12,38 , 'E54S13'),{reusePath: 50});
	    //if(Game.creeps['OutpostDefender-T6-Aiy'].room != '[room E54S13]'){
	    //Game.creeps['OutpostDefender-T6-Aiy'].moveTo( new RoomPosition(9,37, 'E54S13'),{visualizePathStyle :{stroke:' #ffffff ' }});
	   
	    //}
	    //if(Game.creeps['Drainer-T7-Qqa'].room != '[room E53S18]'){
	    //Game.creeps['PoachHauler-T25-Heu'].moveTo( new RoomPosition(47,1, 'E54S16'),{visualizePathStyle :{stroke:' #ffffff ' }});
	    //}
	    
	    //console.log(Game.creeps['OutpostDefender-T6-Aiy'].room != '[room E55S16]');
	    //Game.creeps['OutpostDefender-T5-Xoq'].moveTo( new RoomPosition(47,16 , 'E52S16'),{visualizePathStyle :{stroke:' #ffffff ' }});
	    
	    //if(Game.creeps['SKHealer-T1-Yhv'].heal(Game.creeps['ContainerMiner-T7-Uvw']) == -9){
	    //    Game.creeps['SKHealer-T1-Yhv'].moveTo(Game.creeps['CContainerMiner-T7-Uvw']);
	    //}
	    
	    //if(Game.creeps['ExpansionWorker-T5-Raj'].renewCreep(Game.spawn[''].room.controller,"") == -9){
	    //    Game.creeps['Upgrader-T13-Cqn'].moveTo(Game.creeps['Upgrader-T13-Cqn'].room.controller);
	    //}
...
/***/ (function(module, exports) {
	...
	"use strict";
	(function (Role) {
	    Role[Role["Protector"] = 0] = "Protector";//保护
	    Role[Role["RampartDefender"] = 1] = "RampartDefender";//壁垒防守
	    Role[Role["BaseRanger"] = 2] = "BaseRanger";//基础游侠
	    Role[Role["Ranger"] = 3] = "Ranger";//游侠
	    Role[Role["OutpostSupporter"] = 4] = "OutpostSupporter";//前哨支持者
	    Role[Role["OutpostWarrior"] = 5] = "OutpostWarrior";//前哨战士
	    Role[Role["BaseHauler"] = 6] = "BaseHauler";//基础填充者
	    Role[Role["ProximityScout"] = 7] = "ProximityScout";//观察者
	    Role[Role["OutpostReserver"] = 8] = "OutpostReserver";//前哨
	    Role[Role["Pioneer"] = 9] = "Pioneer";//先锋
	    Role[Role["RoomClaimer"] = 10] = "RoomClaimer";//房间声明
	    Role[Role["MineralMiner"] = 11] = "MineralMiner";//矿物开采者
	    Role[Role["ExpansionWorker"] = 12] = "ExpansionWorker";//扩展房间工作者
	    Role[Role["ContainerMiner"] = 13] = "ContainerMiner";//容器开采者
	    Role[Role["ContainerHauler"] = 14] = "ContainerHauler";//容器填充者
	    Role[Role["OutpostDefender"] = 15] = "OutpostDefender";//前哨防守者
	    Role[Role["Janitor"] = 16] = "Janitor";//看门人
	    Role[Role["Upgrader"] = 17] = "Upgrader";//升级者
	    Role[Role["PoachGuard"] = 18] = "PoachGuard";//偷猎守卫
	    Role[Role["TeamHealer"] = 19] = "TeamHealer";//小组治愈
	    Role[Role["TeamWarrior"] = 20] = "TeamWarrior";//小组战士
	    Role[Role["TeamWrecker"] = 21] = "TeamWrecker";//小组清理
...
/***/ (function(module, exports) {
	...
	;
	const quote = "a,b,c,d,1,2,3,4,Emmmmm,Let me Think......";
	const quotes = [
